// ==========================================================================
// BASE SOURCE TEMPLATES (Used as blueprints for reactive variations)
// ==========================================================================
...
const baseHoldings = [
  ...
  { name: "SBIN", qty: 4, avg: 324.35, price: 430.2, net: "+32.63%", day: "-0.34%", isLoss: false },
  { name: "SGBMAY29", qty: 2, avg: 4727.0, price: 4719.0, net: "-0.17%", day: "+0.15%", isLoss: true },
  { name: "TATAPOWER", qty: 5, avg: 104.2, price: 124.15, net: "+19.15%", day: "-0.24%", isLoss: false },
...
// ==========================================================================
// DYNAMIC USER ROUTING FUNCTIONS (Eliminates Profile Clashing)
// ==========================================================================
...
export const getUserHoldings = () => {
  const currentSessionUser = localStorage.getItem("username") || "Trader";
  
  // FIX: Clear out baseline mocks for *any* custom user profile, allowing database records to dominate
  if (currentSessionUser !== "Trader" && currentSessionUser !== "admin") {
    return []; 
  }
...
// Backwards compatibility fallback exports
export const watchlist = baseWatchlist;
export const holdings = baseHoldings;
export const positions = basePositions;